...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    ...
    private void addVpnActionsToNotification(Notification.Builder nbuilder) {
        ...
        PendingIntent disconnectPendingIntent = PendingIntent.getActivity(this, 0, disconnectVPN, 0 | PendingIntent.FLAG_IMMUTABLE);
        ...
        if (mDeviceStateReceiver == null || !mDeviceStateReceiver.isUserPaused()) {
            ...
            PendingIntent pauseVPNPending = PendingIntent.getService(this, 0, pauseVPN, 0 | PendingIntent.FLAG_IMMUTABLE);
            nbuilder.addAction(R.drawable.ic_menu_pause,
                    getString(R.string.pauseVPN), pauseVPNPending);

        } else {
            pauseVPN.setAction(RESUME_VPN);
            PendingIntent resumeVPNPending = PendingIntent.getService(this, 0, pauseVPN, 0 | PendingIntent.FLAG_IMMUTABLE);
    ...
    PendingIntent getUserInputIntent(String needed) {
        ...
        PendingIntent pIntent = PendingIntent.getActivity(this, 12, intent, 0 | PendingIntent.FLAG_IMMUTABLE);
        return pIntent;
    }
    ...
    PendingIntent getGraphPendingIntent() {
        ...
        intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
        PendingIntent startLW = PendingIntent.getActivity(this, 0, intent, 0 | PendingIntent.FLAG_IMMUTABLE);
        intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
        return startLW;
