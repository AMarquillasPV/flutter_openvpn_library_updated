...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    ...
    PendingIntent getContentIntent() {
        try {
            if (mNotificationActivityClass != null) {
                ...
                return PendingIntent.getActivity(this, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_MUTABLE);
            }
        } catch (Exception e) {
    ...
    private void showNotification(final String msg, String tickerText, @NonNull String channel,
        ...
        if (status == LEVEL_WAITING_FOR_USER_INPUT) {
            PendingIntent pIntent = PendingIntent.getActivity(this, 0, intent, 0 | PendingIntent.FLAG_MUTABLE);
    ...
    private void addVpnActionsToNotification(Notification.Builder nbuilder) {
        ...
        PendingIntent disconnectPendingIntent = PendingIntent.getActivity(this, 0, disconnectVPN, 0 | PendingIntent.FLAG_MUTABLE);
        ...
        if (mDeviceStateReceiver == null || !mDeviceStateReceiver.isUserPaused()) {
            ...
            PendingIntent pauseVPNPending = PendingIntent.getService(this, 0, pauseVPN, 0 | PendingIntent.FLAG_MUTABLE);
            nbuilder.addAction(R.drawable.ic_menu_pause,
                    getString(R.string.pauseVPN), pauseVPNPending);

        } else {
            pauseVPN.setAction(RESUME_VPN);
            PendingIntent resumeVPNPending = PendingIntent.getService(this, 0, pauseVPN, 0 | PendingIntent.FLAG_MUTABLE);
    ...
    PendingIntent getUserInputIntent(String needed) {
        ...
        PendingIntent pIntent = PendingIntent.getActivity(this, 12, intent, 0 | PendingIntent.FLAG_MUTABLE);
        return pIntent;
    }
    ...
    PendingIntent getGraphPendingIntent() {
        ...
        intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
        PendingIntent startLW = PendingIntent.getActivity(this, 0, intent, 0 | PendingIntent.FLAG_MUTABLE);
        intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
        return startLW;
